...
public class PersonsInitialize {
    public static void initializeClasses(List<SchoolClass> schoolClasses) {
    ...
    public static void initializeGraduates(List<Graduate> graduates) {
        try {
    ...
    public static void initializeStudents(List<Person> persons, List<SchoolClass> schoolClasses) {
        try {
    ...
    public static void initializeTeachers(List<Person> persons) {
        try {
